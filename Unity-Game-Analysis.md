...
- **Mine** (ID: 1800007)
- **Church** (ID: 1800008)
- **Beach** (ID: 1800009, accessible when current time is between 8:00-20:00, i.e., when remaining time is between 4-16 hours)
...
4. Set initial time: Day 1, 18 hours remaining (6:00 AM clock time)
